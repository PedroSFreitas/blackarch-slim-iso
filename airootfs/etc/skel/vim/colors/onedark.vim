...
" | Initialization |
" +----------------+
" Change everything from the original
"
...
let s:red = { "gui": "#E06C75", "cterm": "9", "cterm16": "9" } " Alternate cterm: 168
let s:dark_red = { "gui": "#e64040", "cterm": "1", "cterm16": "1" }

let s:green = { "gui": "#98C379", "cterm": "10", "cterm16": "10" }
let s:dark_green = { "gui": "#6dc35c", "cterm": "2", "cterm16": "2" }

let s:yellow = { "gui": "#E5C07B", "cterm": "11", "cterm16": "11" }
let s:dark_yellow = { "gui": "#D19A66", "cterm": "3", "cterm16": "3" }

let s:blue = { "gui": "#61AFEF", "cterm": "12", "cterm16": "12" } " Alternate cterm: 75
let s:dark_blue = { "gui": "#6097dc", "cterm": "4", "cterm16": "4" }

let s:purple = { "gui": "#C678DD", "cterm": "13", "cterm16": "13" } " Alternate cterm: 176
let s:dark_purple = { "gui": "#8d73de", "cterm": "5", "cterm16": "5" }

let s:cyan = { "gui": "#56B6C2", "cterm": "14", "cterm16": "14" } " Alternate cterm: 73
let s:dark_cyan = { "gui": "#53d3d2", "cterm": "6", "cterm16": "6" }

let s:white = { "gui": "#ABB2BF", "cterm": "7", "cterm16" : "7" }

let s:black = { "gui": "#000000", "cterm": "NONE", "cterm16": "NONE" }
let s:visual_black = { "gui": "NONE", "cterm": "NONE", "cterm16": s:black.cterm16 } " Black out selected text in 16-color visual mode

let s:comment_grey = { "gui": "#5C6670", "cterm": "0", "cterm16": "0" }
let s:gutter_fg_grey = { "gui": "#636D83", "cterm": "15", "cterm16": "15" }
let s:gutter_bg_grey = { "gui": "#2C313A", "cterm": "NONE", "cterm16": "NONE" }
let s:cursor_grey =  { "gui": "#2C323B", "cterm": "8", "cterm16": "8" }
let s:visual_grey = { "gui": "#3E4451", "cterm": "15", "cterm16": "15" }
let s:special_grey = { "gui": "#383C45", "cterm": "15", "cterm16": "15" }
